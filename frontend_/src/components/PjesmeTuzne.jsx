...
function PjesmeTuzne() {
  const [tuznePjesme, setTuznePjesme] = useState([]);
  ...
  return (
    <div>
      ...
      <div className="songslist">
        {tuznePjesme.map((pjesma, index) => (
          <div className="songcardtuz" key={index}>
